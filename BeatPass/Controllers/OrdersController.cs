...
namespace BeatPass.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(IFestivalsService festivalsService, ShoppingCart shoppingCart, IOrdersService ordersService)
        {
        ...
        {
            var item = await _festivalsService.GetFestivalByIdAsync(id);
